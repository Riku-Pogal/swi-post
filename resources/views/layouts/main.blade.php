...
<head>
    <link rel="apple-touch-icon" sizes="180x180" href="/massage_apple.png">
    <link rel="icon" type="image/png" sizes="32x32" href="assets/img/massage_chrome.png">
    <link rel="icon" type="image/png" sizes="16x16" href="assets/img/massage_android.png">
    <meta charset="UTF-8">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no" name="viewport">
    <title>APPS Massage ++</title>
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="/mwarna">APPS Massage ++</a>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="/mwarna">Menu</a>
                    </div>
