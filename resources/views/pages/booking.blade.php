...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a class="text-muted">Booking / Pemesanan</a></div>
        </div>
    </div>
    @php
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" name="tgl_doc" value="{{ date("Y-m-d") }}">
                                            </div>
                                        </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-footer text-right">                            
                                ...
                                formaction="{{ route('bookingpost') }}" id="confirm">Save</button>                                
                                <button class="btn btn-secondary" type="reset">Cancel</button>
                                <a class="btn btn-warning mr-1" href="/bookinglist">List</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
        $(document).ready(function() {  
            ...
            $("#jasa").on('select2:select', function(e) {
                    ...
                    success: function(response) {
                        ...
                        for (i=0; i < response.length; i++) {
                            if(response[i].nama_jasa == nama_jasa){
                                $("#hrg_jual").val(response[i].hrg_jual);
                            }
                        }
                        hide_loading()
                    }
            ...
            $("#nama_jasa").on('select2:select', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        for (i=0; i < response.length; i++) {
                            if(response[i].nama_jasa == nama_jasa){
                                $("#hrg_jual").val(thousands_separators(Number(response[i].hrg_jual).toFixed(2)));
