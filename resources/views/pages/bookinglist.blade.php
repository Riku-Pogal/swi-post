...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a class="text-muted">Booking List</a></div>
        </div>
    </div>
    {{-- @php
                            ...
                            <table class="table table-bordered" id="datatable">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="border border-5" style="text-align: center;">No Document</th>
                                        ...
                                        <th scope="col" class="border border-5" style="text-align: center;">lokasi</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border border-5" style="text-align: center;">{{ $item->no_doc }}</td>
                                        <td class="border border-5" style="text-align: center;">{{ date("Y-m-d", strtotime($item->tgl_doc)) }}</td>
                                        ...
                                        <td style="text-align: center;" class="d-flex justify-content-center">                                         
                                                <a href="/booking/{{ $item->id }}/edit"
                                                    class="btn btn-icon icon-left btn-primary"><i class="far fa-edit">
                                                Edit</i></a>
                                                <form action="/booking/delete/{{ $item->id }}" id="del-{{ $item->id }}"
